...
// This set of test cases covers checking the NULL process test cases.
// The NULL process runs in a loop only once the rest of the processes are blocked on memory.
// Requirement 3 is that the NULL process releases the processor and doesn't block other processes and you can see that by looking at the code of the NULL process.
#ifdef AE_ECE350
...
const char   PREFIX[]	  = "G2-TS1";
const char   PREFIX_LOG[]  = "G2-TS1-LOG ";
const char   PREFIX_LOG2[] = "G2-TS1-LOG2";
