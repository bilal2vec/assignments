...
Justifier::Justifier(int MaxLineLength, ifstream &instream, ofstream &outstream) : MaxLineLength(MaxLineLength), instream(instream), outstream(outstream) {}
...
TokenBasedJustifier::TokenBasedJustifier(int MaxLineLength,
                                         ifstream &instream, ofstream &outstream) : Justifier(MaxLineLength, instream, outstream) {}
...
//-- };
//--
//-- // Implement this in Part 2
//-- LineBasedJustifer::LineBasedJustifer(int MaxLineLength,
...
//--     public:
//--         VerbatimJustifier(int MaxLineLength, ifstream &instream,
//--                 ofstream &outstream);
...
//--
//-- // Implement this in Part 2
//-- VerbatimJustifier::VerbatimJustifier(int MaxLineLength,
//-- 	    ifstream &instream, ofstream &outstream) : {}
//--
...
int main(int argc, char *argv[])
{
    ...
    // Adjust the below for Part 2
    case Justifier::Verbatim:
        cerr << "Sorry, verbatim justification is not enabled in Part 1"
             << endl;
        exit(1);
        break;
    }
